...
.AppForm .AppFormLeft button{
    background: linear-gradient(45deg, #6c2524b5, #6c1514);
...
.AppForm .AppFormRight{
    background-image: url('https://images.unsplash.com/photo-1597157639073-69284dc0fdaf?q=80&w=1474&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA==');
    height: 450px;
...
.AppForm .AppFormRight:after{
    ...
    width: 100%;
    height: 100%;
    background: linear-gradient(45deg, #fcdbb4, #6c1514);
